...
p1_title = font.render('Player 1', True, TITANIUM_HWHITE)
p2_title = font.render('Player 2', True, TITANIUM_HWHITE)

p1_points = font.render(str(player1.points), True, TITANIUM_HWHITE)
p1_points_rect = p1_points.get_rect()
p1_points_rect.topleft = (helth_img_size, 80)

p2_points = font.render("{p2}".format(p2=player2.points), True, TITANIUM_HWHITE)
p2_points_rect = p2_points.get_rect()
p2_points_rect.topright = (WIDTH - helth_img_size, 80)
...
while window.running:
    ...
    # Player 1 GUI
    window.screen.blit(p1_title, (helth_img_size - 40, 15))
    window.screen.blit(p1_points, p1_points_rect)

    # Player 2 GUI
    window.screen.blit(p2_title, (WIDTH - helth_img_size - 110, 15))
    window.screen.blit(p2_points, p2_points_rect)
